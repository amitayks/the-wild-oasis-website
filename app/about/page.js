...
export default async function Page() {
  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-5 gap-y-12 sm:gap-y-20 lg:gap-y-32 gap-x-8 lg:gap-x-24 text-base sm:text-lg items-center'>
      ...
      <div className='col-span-1 lg:col-span-2 relative aspect-square order-2 lg:order-none'>
        <Image
